...
if (mysqli_num_rows($result) > 0) {
	...
	if($x==false)
	{
		$vardhan="INSERT INTO  `sql12293332`.`check` (`id` ,`status`)VALUES ('$userid',  'started')";
		$s = "INSERT INTO  `sql12293332`.`result` (`idno`,`marks`,`content`,`adoupload`) VALUES ('$userid',  '0','Not Typed','Not Uploaded')";
...
// Sample usage
var imageUrl = 'http://intranet.rguktn.ac.in/SMS/usrphotos/user/<?php echo $userid.'.jpg';?>';
var a=imageExists(imageUrl, function(exists){
  if(exists)
  {
	  document.getElementById("tstimg").src="http://intranet.rguktn.ac.in/SMS/usrphotos/user/<?php echo $userid.'.jpg';?>";
  }
  else
  {
...
<div> </div><br>
 ...
 <div id="ksr" style="position:absolute;width:100%;left:0%;top:0%;background-image:url(bgm.jpg);left:0%;height:150px">
	 <img src="http://intranet.rguktn.ac.in/SMS/usrphotos/user/<?php echo $userid.'.jpg'; ;?>" id="tstimg" style="position:absolute;top:11%;left:70%;bottom:100%;z-index:111" width="15%" height="125px">

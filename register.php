...
<html lang="en" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <script>
	  function validgen()
		{
		var x=0;
		if(document.getElementById('male_gendr').checked) 
		{
			x++;
		}
		else if(document.getElementById('female_gendr').checked) 
		{
			x++;
		} 
		if(x==0)
...
<body style="width:100%; height:900px;position:absolute;background:url('bgm.jpg'); background-size:100% 100%;background-attachment:scroll;">
 <div> </div><br>
 </center>
...
<div style="position:absolute;left:35%;top:25%;"  id="for">
 ...
 <form method="POST" action="regstr.php" onSubmit="return validgen()" name="registration">
			...
			<label>Choose Gender:</label> &nbsp;<input type="radio" name="gendr" id="female_gendr" style="width: 50px;height :15px;background-color: #FFFFFF;border-radius :8px;" value="F"required><label>Female</label> &nbsp; &nbsp;
			<input type="radio" name="gendr" id="male_gendr" style="width: 50px;height :15px;background-color: #FFFFFF;left:70px;" value="M" required><label>Male</label><br><br>
